...
def-env activate-virtualenv [] {
    ...
    let virtual-env = '/Users/Jason/Desktop/python-virtual-environments/env'
    let bin = 'bin'
    let path-sep = ':'
...
alias deactivate = source '/Users/Jason/Desktop/python-virtual-environments/env/bin/deactivate.nu'
